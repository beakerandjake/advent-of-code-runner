...
export const defaultDataStoreContents = {
  comment: 'Please do not edit this file while running the cli',
};
...
const loadDataFromFile = async () => {
  try {
    ...
    logger.debug('failed to load data store file at: %s, returning default file contents.', dataFilePath);
    return defaultDataStoreContents;
  }
};
